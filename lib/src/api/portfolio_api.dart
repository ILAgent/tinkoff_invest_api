...
class PortfolioApi {
  ...
  ///
  /// 
  Future<Response<PortfolioCurrenciesResponse>> portfolioCurrenciesGet({ 
    ...
    final _path = r'/portfolio/currencies';
    ...
    PortfolioCurrenciesResponse _responseData;

    try {
      const _responseType = FullType(PortfolioCurrenciesResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
      ) as PortfolioCurrenciesResponse;
  ...
  ///
  /// 
  Future<Response<PortfolioResponse>> portfolioGet({ 
    String? brokerAccountId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    PortfolioResponse _responseData;

    try {
      const _responseType = FullType(PortfolioResponse);
      _responseData = _serializers.deserialize(
        _response.data!,
        specifiedType: _responseType,
