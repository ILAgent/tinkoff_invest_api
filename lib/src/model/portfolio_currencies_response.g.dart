...
class _$PortfolioCurrenciesResponse extends PortfolioCurrenciesResponse {
  ...
  _$PortfolioCurrenciesResponse._(
      {required this.trackingId, required this.status, required this.payload})
      : super._() {
    BuiltValueNullFieldError.checkNotNull(
        trackingId, 'PortfolioCurrenciesResponse', 'trackingId');
    BuiltValueNullFieldError.checkNotNull(
        status, 'PortfolioCurrenciesResponse', 'status');
    BuiltValueNullFieldError.checkNotNull(
        payload, 'PortfolioCurrenciesResponse', 'payload');
  }
...
class PortfolioCurrenciesResponseBuilder
  ...
  PortfolioCurrenciesResponseBuilder() {
    PortfolioCurrenciesResponse._initializeBuilder(this);
  }
