...
Serializer<MarketOrderResponse> _$marketOrderResponseSerializer =
    new _$MarketOrderResponseSerializer();

class _$MarketOrderResponseSerializer
    implements StructuredSerializer<MarketOrderResponse> {
  @override
  final Iterable<Type> types = const [
    MarketOrderResponse,
    _$MarketOrderResponse
  ];
  @override
  final String wireName = 'MarketOrderResponse';

  @override
  Iterable<Object> serialize(
      Serializers serializers, MarketOrderResponse object,
  ...
  @override
  MarketOrderResponse deserialize(
      Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new MarketOrderResponseBuilder();
...
class _$MarketOrderResponse extends MarketOrderResponse {
  ...
  _$MarketOrderResponse._({this.trackingId, this.status, this.payload})
      : super._();
