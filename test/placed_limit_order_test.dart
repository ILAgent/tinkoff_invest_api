...
// tests for PlacedLimitOrder
void main() {
  final instance = PlacedLimitOrderBuilder();
  // TODO add properties to the builder and call build()

  group(PlacedLimitOrder, () {
    // String orderId
    ...
    // int requestedLots
    test('to test the property `requestedLots`', () async {
      // TODO
    });

    // int executedLots
    test('to test the property `executedLots`', () async {
      // TODO
    });
