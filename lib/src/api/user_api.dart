...
class UserApi {
  ...
  ///
  /// 
  Future<Response<UserAccountsResponse>> userAccountsGet({ 
    ...
    UserAccountsResponse _responseData;

    try {
      const _responseType = FullType(UserAccountsResponse);
